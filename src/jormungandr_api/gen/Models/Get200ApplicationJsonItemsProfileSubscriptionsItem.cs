...
namespace Jormungandr.Models
{
    ...
    /// a subscription
    /// </summary>
    public partial class Get200ApplicationJsonItemsProfileSubscriptionsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Get200ApplicationJsonItemsProfileSubscriptionsItem class.
        /// </summary>
        public Get200ApplicationJsonItemsProfileSubscriptionsItem()
        {
            CustomInit();
        }
        ...
        /// topic</param>
        public Get200ApplicationJsonItemsProfileSubscriptionsItem(string interest, int topic)
        {
            Interest = interest;
            Topic = topic;
            CustomInit();
